...
const TaskOverview = () => {
  ...
  const projectCards = [
    ...
    { id: 2, name: "Project Name", status: "In Progress" },
    { id: 2, name: "Project Name", status: "In Progress" },
    { id: 3, name: "Project Name", status: "In Revision" },
    { id: 3, name: "Project Name", status: "In Revision" },
    { id: 3, name: "Project Name", status: "In Revision" },
    { id: 3, name: "Project Name", status: "In Revision" },
  ...
  const categorizedProjects = {
    ...
    "In Revision": projectCards.filter(
      (project) => project.status === "In Revision"
    ),
    ...
    <div className="project-overview">
      ...
      <div className="subHeader">
        <div className="headerBottom">
          <h2 className="project-subtitle">All Tasks</h2>
          ...
          <table>
              ...
              <tr>
                ...
                <th>
                  <div className="content-wrapper">
                    <FolderIcon className="folderTable-icon" /> Project Name
                  </div>
                </th>
                <th>%</th>
                <th>
                  <div className="content-wrapper">
                    <PeopleTableIcon className="folderTable-icon" /> Owner
                  </div>
                </th>
                <th>
                  <div className="content-wrapper">
                    <TaskTableIcon className="folderTable-icon" />
                    Tasks
                  </div>
                </th>
                <th>
                  <div className="content-wrapper">
                    <StatusTableIcon className="folderTable-icon" />
                    Status
                  </div>
                </th>
                <th>
                  <div className="content-wrapper">
                    <CalenderIcon className="folderTable-icon" />
                    Start Date
                  </div>
                </th>
                <th>
            ...
            <tbody>
              {Array.from({ length: 10 }, (_, index) => {
                ...
                let statusColor =
                  "var(--Project-Creation-Status-Not-Started, #3B78A3)";

                if (projectId === 2) {
                  statusText = "On Track";
                  statusColor =
                    "var(--Project-Creation-Status-In-Progress, #CAC000)";
                } else if (projectId === 3) {
                  statusText = "Delayed";
                  statusColor =
                    "var(--Project-Creation-Status-Completed, #F42E2E)";
                } else if (projectId === 4) {
                  statusText = "In Revision";
                  statusColor =
                    "var(--Project-Creation-Status-Archived, #3E4B4F)";
                }
                ...
                return (
                  <tr key={projectId}>
                    ...
                    <td>
                      {" "}
                      <div className="content-wrapper">
                        <ImageIcon className="imageIcon" /> Techyon
                      </div>
                    </td>{" "}
                    <td>
                      {" "}
